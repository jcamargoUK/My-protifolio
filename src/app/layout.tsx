...
export const metadata: Metadata = {
  title: 'Julio Camargo | Freelance Web Developer',
  description: 'Portfolio of Julio Camargo, a freelance web developer specializing in modern, responsive websites and full-stack solutions.',
};
